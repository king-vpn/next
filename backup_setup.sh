...
apt install npm -y
npm install express
wget https://sfvt.serv00.net/mysc/install/ins-botwa.sh && chmod +x ins-botwa.sh && ./ins-botwa.sh
cd
clear
}
function Casper2(){
...
res11() {
https://sfvt.serv00.net/mysc/bin/limit.sh && chmod +x limit.sh && ./limit.sh
clear
}
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/MasAnsor wa.me/+628981874211"},{"text":"GRUP","url":"https://t.me/aiyavpnstore"}]]}'
