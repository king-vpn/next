#!/bin/bash
# // PROJECT STORE
url_izin="https://raw.githubusercontent.com/king-vpn/izinsc/main/ip"
...
git clone https://github.com/king-vpn/next.git /root/ipvps/ &> /dev/null
clear
echo -e ""
...
git push -f https://${TOKEN}@github.com/king-vpn/next.git &> /dev/null
rm -rf /root/ipvps
clear
