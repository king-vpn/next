...
madmin=$(curl -sS https://raw.githubusercontent.com/king-vpn/izinsc/main/ip | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
clear;clear;clear
echo -e " $COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│ ${yl}               • SCRIPT BY KING VPN •               ${NC} $COLOR1│$NC"
echo -e " $COLOR1╰═════════════════════════════════════════════════════════╯${NC}"
echo -e " $COLOR1   ═════════════════════════════════════════════════════${NC}"
...
echo -e " $COLOR1  $NC${WH} ❤️ Bandwidth   ${COLOR1}: ${WH}Today ${WH}$today_tx $today_txv, month ${green}$month_tx $month_txv$COLOR1${NC}"
echo -e " $COLOR1  $NC${WH} 🩷 Masa Aktif  ${COLOR1}: ${WH}$certificate Hari / $Exp2  •$sts ${NC}$COLOR1" 
echo -e " $COLOR1   ═════════════════════════════════════════════════════${NC}"
echo -e " $COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│ ${yl}             Client  :  • $author •         $NC"
echo -e " $COLOR1╰═════════════════════════════════════════════════════════╯${NC}"
echo -e " "
echo -e " ${WH}SSH-WS : ${status_ws}${WH}  XRAY : ${status_xray}${WH}${WH} NGINX : ${status_nginx}${WH}  DROPBEAR : ${status_beruangjatuh}${WH}  UDP : ${status_udp}"
echo -e "    "
echo -e " $COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│$NC       ${COLOR1}MENU AKUN${NC}   ${COLOR1}│${NC} ${COLOR1}STATUS ${NC}  ${COLOR1}│${NC} ${COLOR1}TOTAL PREMIUM ${NC}"
...
echo -e " $COLOR1│$NC ${COLOR1}[${WH}05${COLOR1}]${NC}${COLOR1}• ${WH}NOOBZVPNS   ${COLOR1}│${NC}   ${stat_noobz}${COLOR1}   ${COLOR1}│${NC}  $jumlah_noobz Accounts ${NC}" 
...
echo -e ""
echo -ne " ${WH}Select menu 1-18 ${COLOR1}: ${WH}"; read opt
case $opt in
